// organizar o nome do alunos, as notas e a médias
let alunos = []
...
function calcular(){
    ...
    if(media_geral > 50){
        document.getElementById('colmedia').style.backgroundColor = '#32cd32'
        ...
        document.getElementById('colmedia').style.backgroundColor = '#ff0000'
        document.getElementById('media_geral').style.color = 'white'
        document.getElementById('txt_media').style.color = 'white'
    }else{
        document.getElementById('colmedia').style.backgroundColor = '#ffe600'
